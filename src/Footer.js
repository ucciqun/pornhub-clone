    ...
    <div className="footer">
      ...
      {textToogle ? (
        <div className="footer__description">
          <p>
            Pornhub-cloneチームは、毎日エロ動画をアップデートしています。全てがそろった100%無料エロ動画集。自由にダウンロードできる膨大な無料エロDVDセレクション。Pornhubは最も完璧かつ革新的なエロ動画チューブサイトです。ストリーミング・エロ動画・ビデオ、ダウンロード可能なエロDVD、フォトアルバム、そして、ネット上でNo.1の無料セックスコミュニティー。刺激的でよりよいエロ動画生活がおくれるよう、私たちは常に新機能を追加しています。いつでも質問やコメントを送ってください。
        ...
        <div className="footer__description">
          <p>
            Pornhub-cloneチームは、毎日エロ動画をアップデートしています。全てがそろった100%無料エロ動画集。自由にダウンロードできる膨大な無料エロDVDセレクション。Pornhubは最も完璧かつ革新的なエロ動画チューブサイトです。ストリーミン...
